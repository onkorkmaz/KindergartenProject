<%@ Page Title="" Language="C#" MasterPageFile="~/kindergarten.Master" AutoEventWireup="true" CodeBehind="StudentAttendanceBookListTest.aspx.cs" Inherits="KindergartenProject.StudentAttendanceBookListTest" %>

<%@ Register Src="~/userControl/divInformation.ascx" TagPrefix="uc1" TagName="divInformation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="/customJS/studentAttendanceBookTest.js"></script>
